...
// Sprint S1 fetch-mocked describe block REMOVED 2026-05-11.
// Per AI_CONTRIBUTING fetch-mock e2e is forbidden — the real
// end-to-end verification lives in tradingbot-platform/backend/
// scripts/prod_smoke_fleet.py which hits the LIVE Caddy URL
// (https://tradingbot.72-60-185-57.sslip.io) and asserts the
// full chain (/champions, /compare with _nofilter ids, /chart-data
// with rejected_signals + shadow_signals, per-strategy signal
// health post-warmup). Run via cron / GH Action with notify-on-fail.
